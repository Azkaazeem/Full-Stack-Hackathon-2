        ...
        <div className="overflow-x-auto bg-white rounded-xl shadow-sm border border-gray-200">
          <table className="min-w-full text-left text-sm whitespace-nowrap">
            <thead className="uppercase tracking-wider border-b-2 bg-gray-50 border-gray-200">
              <tr>
                <th scope="col" className="px-6 py-4 font-bold text-gray-800">Name</th>
                <th scope="col" className="px-6 py-4 font-bold text-gray-800">Event</th>
                <th scope="col" className="px-6 py-4 font-bold text-gray-800">Availability</th>
              </tr>
            </thead>
            <tbody>
